    ...
    ***************************************************************************** */
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, axios__default['default'].get('https://blockchain.info/ticker')];
                    case 1:
                        data = (_a.sent()).data;
    ...
    Module.register('MMM-NiceHash', {
        ...
        socketNotificationReceived: function (notification, payload) {
            return __awaiter(this, void 0, void 0, function () {
                var sellingPrice, profitability, rigs, unknownError_1, error;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                        ...
                        case 1:
                            _a.trys.push([1, 3, , 4]);
                            return [4 /*yield*/, getCurrencyValue(this.config.currency)];
                        case 2:
