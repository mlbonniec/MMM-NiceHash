(function () {
	...
	var conversions = createCommonjsModule(function (module, exports) {
	...
	exports.perYear = exports.perMonth = exports.perWeek = exports.toCurrency = exports.getCurrencyValue = void 0;
	var axios_1 = __importDefault(axios);
	var currencies = ['USD', 'AUD', 'BRL', 'CAD', 'CHF', 'CLP', 'CNY', 'DKK', 'EUR', 'GBP', 'HKD', 'INR', 'ISK', 'JPY', 'KRW', 'NZD', 'PLN', 'RUB', 'SEK', 'SGD', 'THB', 'TRY', 'TWD'];
	        ...
	        return __generator(this, function (_a) {
	            switch (_a.label) {
	                case 0:
	                    ...
	                    return [4 /*yield*/, axios_1.default.get('https://blockchain.info/ticker')];
	                case 1:
	                    data = (_a.sent()).data;
	                    return [2 /*return*/, data[currency].sell];
	            }
	        });
	    });
	}
	exports.getCurrencyValue = getCurrencyValue;
	function toCurrency(BTC, sellingPrice) {
	        ...
	        return __awaiter(this, void 0, void 0, function () {
	            ...
	            return __generator(this, function (_a) {
	                switch (_a.label) {
	                    ...
	                    case 1:
	                        _a.trys.push([1, 3, , 4]);
	                        return [4 /*yield*/, conversions.getCurrencyValue(this.config.currency)];
	                    case 2:
	                        sellingPrice = _a.sent();
	                        profitability = payload.totalProfitability, rigs = payload.rigs;
	                        this.rigs = rigs;
	                        this.incomes = {
	                            day: conversions.toCurrency(profitability, sellingPrice),
	                            week: conversions.toCurrency(conversions.perWeek(profitability), sellingPrice),
	                            year: conversions.toCurrency(conversions.perYear(profitability), sellingPrice),
	                        };
	                        this.updateDom();
	                        return [3 /*break*/, 4];
	                    case 3:
